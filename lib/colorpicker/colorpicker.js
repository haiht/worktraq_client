...
jQuery.fn.colourPicker = function (conf) {
	...
	return this.each(function () {
		...
		var input	= jQuery('<input readonly="readonly" style="border:1px solid; width:20px; height:20px" type="text" name="' + select.attr('name') + '" value="' + select.val() + '" size="6" />').insertAfter(select);
		var loc		= '';
