...
$v_package_type = isset($_POST['txt_package_type'])?$_POST['txt_package_type']:0;
$v_graphic_id = isset($_POST['txt_graphic_id'])?$_POST['txt_graphic_id']:0;
...
$v_product_description = isset($_POST['txt_product_description'])?$_POST['txt_product_description']:'';
...
$v_size_length = isset($_POST['txt_size_length'])?$_POST['txt_size_length']:'';
$v_size_unit = isset($_POST['txt_size_unit'])?$_POST['txt_size_unit']:'';
$v_size_option = isset($_POST['txt_size_option'])?$_POST['txt_size_option']:'0';
