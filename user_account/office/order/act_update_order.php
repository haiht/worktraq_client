...
$v_date_required = isset($_POST['txt_date_required'])?$_POST['txt_date_required']:NULL;
        ...
        if($v_current_order_status<20 && $v_current_order_status>0){
            ...
            if($v_result){
                if($v_mail_send>0){
                    ...
                    $v_mail_send = send_mail($cls_mail,'Anvy Website Worktraq', 'info@anvyinc.com', $arr_to_mail,$v_mail_subject, $v_mail_body);
