...
{
    $v_support_title = isset($_POST['txt_support_title'])?$_POST['txt_support_title']:'';
    ...
    if($v_error=='')
    {
        ...
        if($v_result!=''){
            $v_error = '<h4 align="center" style="color:#AD8100">  Thank you!.... </h4> ';
            /*Send email */
...
$tpl_support->set('EROR_RESULT',$v_error);
