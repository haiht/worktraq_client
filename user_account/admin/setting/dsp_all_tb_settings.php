        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Setting Name or Description" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Settings</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Settings"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_setting_name:'<?php echo isset($v_search_setting_name)?htmlspecialchars($v_search_setting_name):'';?>',txt_search_setting_description:'<?php echo isset($v_search_setting_description)?htmlspecialchars($v_search_setting_description):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_settings"
						...
						columns: [
							...
							{field: "setting_name", title: "Setting Name", type:"string", width:"80px", sortable: true },
							...
							{field: "setting_description", title: "Setting Description", type:"string", width:"150px", sortable: true },
							{field: "setting_type", title: "Setting Type", type:"int", width:"50px", sortable: true, template: '<span style="float:right">#= kendo.toString(setting_type,"n0") #</span>'},
							{ command:  [
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.setting_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit settings with ID: '+dataItem.setting_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.setting_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete settings with ID: '+dataItem.setting_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.setting_id+"/delete";
                    }
                }
            </script>
                </div>
