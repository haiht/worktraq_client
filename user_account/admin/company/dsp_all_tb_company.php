        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Company Name or Company Code" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Company</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Company"
                                });
                            }
						...
						columns: [
							...
							{field: "company_name", title: "Company Name", type:"string", width:"80px", sortable: true },
							{field: "company_code", title: "Code", type:"string", width:"30px", sortable: true },
							{field: "relationship", title: "Relationship", type:"string", width:"50px", sortable: true},
							{field: "bussines_type", title: "Bussines Type", type:"string", width:"50px", sortable: true},
							{field: "industry", title: "Industry", type:"string", width:"50px", sortable: true},
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.company_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit company with ID: '+dataItem.company_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.company_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete company with ID: '+dataItem.company_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.company_id+"/delete";
                    }
                }
            </script>
                </div>
