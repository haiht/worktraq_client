        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Material Name" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Material</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Material"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_quick_search:'<?php echo isset($v_quick_search)?$v_quick_search:'';?>', txt_search_company_id: '<?php echo $v_company_id;?>', txt_search_material_name:'<?php echo isset($v_quick_search)?$v_quick_search:'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_material"
						...
						columns: [
							...
							{field: "material_name", title: "Material Name", type:"string", width:"100px", sortable: true },
							{field: "description", title: "Description", type:"string", width:"150px", sortable: true },
							{field: "size_option", title: "Size Option", type:"int", width:"50px", sortable: true, template: '<span style="float:right">#= size_option==1?"Allow":"Not Allow" #</span>'},
							{field: "two_sided_print", title: "2-Sided Print", type:"int", width:"50px", sortable: true, template: '<span style="float:right">#= two_sided_print==1?"Yes":"No" #</span>'},
							{field: "material_type", title: "Material Type", type:"string", width:"50px", sortable: true},
							{field: "status", title: "Status", type:"int", width:"50px", sortable: true, template: '<span style="float:right">#= status==0?"Active":"Inactive" #</span>'},
							{ command:  [
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.material_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit material with ID: '+dataItem.material_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.material_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete material with ID: '+dataItem.material_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.material_id+"/delete";
                    }
                }
            </script>
                </div>
