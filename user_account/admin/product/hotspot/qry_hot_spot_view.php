...
if($v_product_images_id>0){
    ...
    if($v_row==1){
        ...
        //if(file_exists($v_saved_dir.PRODUCT_IMAGE_NORMAL.'_'.$v_product_image))
        //    $v_product_image_url = $v_saved_dir.PRODUCT_IMAGE_NORMAL.'_'.$v_product_image;
        //else
        //    $v_product_image_url = $v_saved_dir.PRODUCT_IMAGE_NORMAL.$v_product_image;
