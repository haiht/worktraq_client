    ...
    if(!is_null($arr_material_option)){
        if(is_array($arr_material_option)){
            ...
            for($i=0; $i<count($arr_material_option);$i++){
                $v_color_code = isset($arr_material_option[$i]['color'])?$arr_material_option[$i]['color']:'';
                $v_thick = isset($arr_material_option[$i]['thick'])?$arr_material_option[$i]['thick']:0;
                $v_unit = isset($arr_material_option[$i]['unit'])?$arr_material_option[$i]['unit']:'mm';
