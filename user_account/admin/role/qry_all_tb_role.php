...
if(isset($_POST['btn_advanced_search'])){
    ...
    if(isset($_SESSION['ss_tb_role_redirect']) && $_SESSION['ss_tb_role_redirect']==1){
        $v_page = isset($_SESSION['ss_tb_role_page'])?$_SESSION['ss_tb_role_page']:'1';
        settype($v_page,'int');
        ...
        $v_quick_search = isset($_SESSION['ss_tb_role_quick_search'])?$_SESSION['ss_tb_role_quick_search']:'';
    }
}
