...
switch($v_act){
	...
	case 'J':
        ...
        if($v_json_type=='load_province')
    		include 'qry_json_tb_province.php';
        else if($v_json_type=='load_country')
            include 'qry_json_load_country.php';
		break;
	case 'X':
		if($v_report_right || $v_is_admin){
			include 'qry_export_tb_province.php';
		}else{
			redir(URL.'admin/error/');
		}
		break;
	case 'AJ':
        ...
        if($v_ajax_type=='check_province_key'){
            include 'qry_ajax_check_province_key.php';
        }
		break;
	case 'P':
		if($v_report_right || $v_is_admin){
			include 'qry_print_tb_province.php';
			include 'user_account/admin/print_header.php';
			include 'dsp_print_tb_province.php';
