        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Province Name" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Province</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Province"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_json_type:'load_province',txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_province_name:'<?php echo isset($v_search_province_name)?htmlspecialchars($v_search_province_name):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_province"
						...
						columns: [
							...
							{field: "province_name", title: "Province Name", type:"string", width:"100px", sortable: true },
							{field: "province_key", title: "Province Key", type:"string", width:"50px", sortable: true },
							{field: "province_status", title: "Province Status", type:"int", width:"50px", sortable: true, template: '<span style="float:right">#= province_status==0?"Active":"Inactive" #</span>'},
							{field: "country_name", title: "Country", type:"string", width:"80px", sortable: true},
							{ command:  [
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.province_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit province with ID: '+dataItem.province_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.province_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete province with ID: '+dataItem.province_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.province_id+"/delete";
                    }
                }
            </script>
                </div>
