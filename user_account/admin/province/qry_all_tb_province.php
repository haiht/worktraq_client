...
if(isset($_POST['btn_advanced_search'])){
	...
	if(isset($_SESSION['ss_tb_province_redirect']) && $_SESSION['ss_tb_province_redirect']==1){
		$v_page = isset($_SESSION['ss_tb_province_page'])?$_SESSION['ss_tb_province_page']:'1';
		settype($v_page,'int');
		...
		$v_quick_search = isset($_SESSION['ss_tb_province_quick_search'])?$_SESSION['ss_tb_province_quick_search']:'';
	}
    $v_search_province_name = $v_quick_search;
}
