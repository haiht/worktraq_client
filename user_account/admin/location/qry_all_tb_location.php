...
if(isset($_POST['btn_advanced_search'])){
	...
	if(isset($_SESSION['ss_tb_location_redirect']) && $_SESSION['ss_tb_location_redirect']==1){
		$v_page = isset($_SESSION['ss_tb_location_page'])?$_SESSION['ss_tb_location_page']:'1';
		settype($v_page,'int');
		...
		$v_quick_search = isset($_SESSION['ss_tb_location_quick_search'])?$_SESSION['ss_tb_location_quick_search']:'';
	}
    $v_search_location_name = $v_quick_search;
    $v_search_location_number = $v_quick_search;
}
