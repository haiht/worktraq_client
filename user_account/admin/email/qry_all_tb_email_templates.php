...
if(isset($_POST['btn_advanced_search'])){
	...
	if(isset($_SESSION['ss_tb_email_templates_redirect']) && $_SESSION['ss_tb_email_templates_redirect']==1){
		$v_page = isset($_SESSION['ss_tb_email_templates_page'])?$_SESSION['ss_tb_email_templates_page']:'1';
		settype($v_page,'int');
		...
		$v_quick_search = isset($_SESSION['ss_tb_email_templates_quick_search'])?$_SESSION['ss_tb_email_templates_quick_search']:'';
	}
    $v_search_email_data = $v_quick_search;
    $v_search_email_key = $v_quick_search;
