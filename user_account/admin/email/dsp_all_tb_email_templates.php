        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Email Key or Email Data" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Email_templates</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Email_templates"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_email_key:'<?php echo isset($v_search_email_key)?htmlspecialchars($v_search_email_key):'';?>',txt_search_email_data:'<?php echo isset($v_search_email_data)?htmlspecialchars($v_search_email_data):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_email_templates"
                                    ,total: function(data){
						...
						columns: [
							...
							{field: "email_key", title: "Email Key", type:"string", width:"100px", sortable: true },
							{field: "email_file", title: "Email File", type:"string", width:"80px", sortable: true },
							{field: "email_data", title: "Email Data", type:"string", width:"80px", sortable: true },
							{field: "email_type", title: "Email Type", type:"string", width:"50px", sortable: true },
							{field: "description", title: "Description", type:"string", width:"100px", sortable: true },
							{ command:  [
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.email_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit email_templates with ID: '+dataItem.email_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.email_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete email_templates with ID: '+dataItem.email_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.email_id+"/delete";
                    }
                }
            </script>
                </div>
