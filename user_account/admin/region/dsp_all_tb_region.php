        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Region Name" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Region</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Region"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_json_type:'load_region',txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_region_name:'<?php echo isset($v_search_region_name)?htmlspecialchars($v_search_region_name):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_region"
						...
						columns: [
                            ...
                            {field: "region_name", title: "Region Name", type:"string", width:"100px", sortable: true },
							{field: "company_name", title: "Company", type:"string", width:"100px", sortable: true},
							{field: "region_contact", title: "Region Contact", type:"string", width:"80px", sortable: true},
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.region_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit region with ID: '+dataItem.region_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.region_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete region with ID: '+dataItem.region_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.region_id+"/delete";
                    }
                }
            </script>
                </div>
