...
add_class('cls_tb_location_log', 'cls_tb_location_log.php');
$cls_tb_location_log = new cls_tb_location_log($db, LOG_DIR);
...
switch($v_act){
	case 'N':
		if($v_create_right || $v_is_admin){
			include 'qry_single_tb_region.php';
			include 'user_account/admin/admin_header.php';
			include 'dsp_single_tb_region.php';
	...
	case 'D':
		if($v_delete_right || $v_is_admin){
			include 'act_delete_tb_region.php';
		}else{
			redir(URL.'admin/error/');
		}
		break;
	case 'J':
        ...
        if($v_json_type=='load_region')
		    include 'qry_json_tb_region.php';
        ...
        else if($v_json_type=='load_location_log')
            include 'qry_json_load_location_log.php';
		break;
	case 'X':
		if($v_report_right || $v_is_admin){
			include 'qry_export_tb_region.php';
		}else{
			redir(URL.'admin/error/');
		}
		break;
	case 'AJ':
        ...
        if($v_ajax_type=='load_region_info')
            include 'qry_ajax_load_region_info.php';
        else if($v_ajax_type=='check_region_key')
            include 'qry_ajax_check_region_key.php';
		break;
	case 'P':
		if($v_report_right || $v_is_admin){
			include 'qry_print_tb_region.php';
			include 'user_account/admin/print_header.php';
			include 'dsp_print_tb_region.php';
	...
	default:
		if($v_view_right || $v_is_admin){
			$v_act = 'A';
			include 'qry_all_tb_region.php';
			include 'user_account/admin/admin_header.php';
			include 'dsp_all_tb_region.php';
			include 'user_account/admin/admin_footer.php';
		}else{
			redir(URL.'admin/error/');
		}
