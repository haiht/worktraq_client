    ...
    for($j=0;$j<$v_total_allocation;$j++)
    {
        ...
        <table align="center" width="100%" border="1" class="list_table" cellpadding="3" cellspacing="0">
            ...
            ?>
                    ...
                    <tr>
                        <td>Tracking Company...</td>
                        <td colspan="2"><?php echo $arr_tmp['shipper']; ?> </td>
                    </tr>
                    <tr>
                        <td>Tracking Number...</td>
                        <td><b></b><?php echo $arr_tmp['tracking_number']; ?> </b></td>
                        <td>Check URL: <?php echo $arr_tmp['tracking_url']; ?> </td>
                    </tr>
                    <tr>
                        <td>Date Shipping...</td>
                        <td colspan="2"><?php echo $v_ship_date; ?> </td>
                    </tr>
            <?php
                }
            }
