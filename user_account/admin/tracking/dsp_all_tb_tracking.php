        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Tracking Company" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Tracking</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Tracking"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>",txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_tracking_name:'<?php echo isset($v_search_tracking_name)?htmlspecialchars($v_search_tracking_name):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_tracking"
						...
						columns: [
							...
							{field: "tracking_name", title: "Tracking Name", type:"string", width:"80px", sortable: true },
							{field: "website", title: "Website", type:"string", width:"100px", sortable: true, encoded:false },
							{field: "phone", title: "Phone", type:"string", width:"50px", sortable: true, template:'<span style="float: right">#= phone #</span>' },
							{field: "email", title: "Email", type:"string", width:"80px", sortable: true, encoded:false },
							{field: "contact_name", title: "Contact Name", type:"string", width:"50px", sortable: true },
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.tracking_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit tracking with ID: '+dataItem.tracking_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.tracking_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete tracking with ID: '+dataItem.tracking_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.tracking_id+"/delete";
                    }
                }
            </script>
                </div>
