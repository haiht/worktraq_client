        ...
        <div id="div_splitter_content" style="height: 100%; width: 100%;">
            ...
            <div id="div_right_pane">
                <div class="pane-content">
                    ...
                    <input type="text" name="txt_quick_search" placeholder="Search by Support Title or Contact Name" value="<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>" />
                    ...
                    <h2>Advanced Search for Support</h2>
				...
				<script type="text/javascript">
                    ...
                    $(document).ready(function() {
                        ...
                        $('li#icons_advanced_search').bind("click", function() {
                            if (!window_search.data("kendoWindow")) {
                                window_search.kendoWindow({
                                    ...
                                    modal: true,
                                    title: "Advanced Search for Support"
                                });
                            }
                            ...
                            dataSource: {
                                ...
                                transport: {
                                    read: {
                                        ...
                                        type: "POST",
                                        data: {txt_session_id:"<?php echo session_id();?>", txt_json_type:'load_support', txt_quick_search:'<?php echo isset($v_quick_search)?htmlspecialchars($v_quick_search):'';?>', txt_search_company_id: '<?php echo $v_company_id;?>',txt_search_support_title:'<?php echo isset($v_search_support_title)?htmlspecialchars($v_search_support_title):'';?>',txt_search_contact_name:'<?php echo isset($v_search_contact_name)?htmlspecialchars($v_search_contact_name):'';?>'}
                                    }
                                },
                                schema: {
                                    data: "tb_support"
						...
						columns: [
							...
							{field: "support_title", title: "Support Title", type:"string", width:"50px", sortable: true },
							{field: "support_description", title: "Support Description", type:"string", width:"80px", sortable: true },
							{field: "company_name", title: "Company", type:"string", width:"80px", sortable: true},
							{field: "contact", title: "Contact", type:"string", width:"80px", sortable: false, encoded: false},
							{field: "username", title: "Username", type:"string", width:"50px", sortable: true },
							{field: "image_file", title: "Image File", type:"string", width:"80px", sortable: true },
							{ command:  [
              ...
              function view_row(e) {
                    ...
                    document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.support_id+"/view";
                }
                function edit_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to edit support with ID: '+dataItem.support_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.support_id+"/edit";
                    }
                }
                function delete_row(e) {
                    e.preventDefault();
                    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
                    if(confirm('Do you want to delete support with ID: '+dataItem.support_id+'?')){
                        document.location = "<?php echo URL.$v_admin_key.'/';?>"+dataItem.support_id+"/delete";
                    }
                }
            </script>
                </div>
