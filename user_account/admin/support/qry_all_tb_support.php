...
<?php
$v_quick_search = '';
$v_search_contact_name = '';
$v_search_support_title = '';
$v_company_id = 0;
$v_page = 1;
if(isset($_POST['btn_advanced_search'])){
	...
	if(isset($_SESSION['ss_tb_support_redirect']) && $_SESSION['ss_tb_support_redirect']==1){
		$v_page = isset($_SESSION['ss_tb_support_page'])?$_SESSION['ss_tb_support_page']:'1';
		settype($v_page,'int');
		...
		$v_quick_search = isset($_SESSION['ss_tb_support_quick_search'])?$_SESSION['ss_tb_support_quick_search']:'';
	}
    $v_search_contact_name = $v_quick_search;
    $v_search_support_title = $v_quick_search;
}
