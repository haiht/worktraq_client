...
<script type="text/javascript" src="[@URL_TEMPLATES]/js/nino.js"></script>
<link href="[@URL_TEMPLATES]/css/nino.css" rel="stylesheet" type="text/css">
<script>
...
<div class="slide">
    <div class="slideshow theme-light">
        <div id="slider" class="nivoSlider">
            <!--img src="[@SLIDE_IMAGE_URL]/background.jpg" /-->
...
<span style="[@NOTICE_DISPLAY]">
<p class="title_lates">
    [@NOTICE_TITLE]
</p>
<p class="error" style="[@NOTICE_DISPLAY]">
    [@NOTICE_DESCRIPTION]
</p>
</span>
<div class="bottom_slide">
    <div class="left_bt"></div>
    <a href="#" class="about">About WorkTraq</a>
</div>
<div class="content-news" style="text-align: justify;padding-left: 2px; margin-top: 10px;">
