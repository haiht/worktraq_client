...
if($v_allocation_data!=''){
    ...
    //$v_tmp_product_id = $arr_allocation_data[0][0];
                    ...
                    for($i=0; $i<$v_total;$i++){
                        ...
                        foreach($arr_location as $a){
                            ...
                            if($v_tmp_location_id==$a['location_id']){
                                ...
                                //$v_tracking_number = $a['tracking_number'];
                            ...
                            //    $arr_allocation[] = array('location_id'=>$a['location_id'],'location_name'=>$v_location_name,'location_address'=>'', 'location_quantity'=>0, 'location_price'=>0, 'product_id'=>0, 'product_image'=>0, 'product_name'=>'','tracking_url'=>$v_tracking_url, 'tracking_number'=>$v_tracking_number,'tracking_company'=>$v_tracking_company, 'date_shipping'=> $v_date_shipping, 'shipping_status'=>$v_shipping_status, 'delete'=>1);
                            //}
                        }
                    }
                    foreach($arr_location as $a){
