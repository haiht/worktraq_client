<?php
class cls_tb_thickness{

	private $v_thickness_id = 0;
	private $v_thickness_name = '';
	private $v_thickness_size = '';
	private $v_thickness_type = '';
	...
	public function __construct(MongoDB $db, $p_log_dir = ""){
		...
		$this->collection = $db->selectCollection('tb_thickness');
		$this->collection->ensureIndex(array("thickness_id"=>1), array('name'=>"thickness_id_key", "unique"=>1, "dropDups" => 1));
	}
	...
	/**
	 * function return properties "thickness_id" value
	 * @return int value
	 */
	public function get_thickness_id(){
		return (int) $this->v_thickness_id;
	}

	
	/**
	 * function allow change properties "thickness_id" value
	 * @param $p_thickness_id: int value
	 */
	public function set_thickness_id($p_thickness_id){
		$this->v_thickness_id = (int) $p_thickness_id;
	}

	
	/**
	 * function return properties "thickness_name" value
	 * @return string value
	 */
	public function get_thickness_name(){
		return $this->v_thickness_name;
	}

	
	/**
	 * function allow change properties "thickness_name" value
	 * @param $p_thickness_name: string value
	 */
	public function set_thickness_name($p_thickness_name){
		$this->v_thickness_name = $p_thickness_name;
	}

	
	/**
	 * function return properties "thickness_size" value
	 * @return string value
	 */
	public function get_thickness_size(){
		return $this->v_thickness_size;
	}

	
	/**
	 * function allow change properties "thickness_size" value
	 * @param $p_thickness_size: string value
	 */
	public function set_thickness_size($p_thickness_size){
		$this->v_thickness_size = $p_thickness_size;
	}

	
	/**
	 * function return properties "thickness_type" value
	 * @return string value
	 */
	public function get_thickness_type(){
		return $this->v_thickness_type;
	}

	
	/**
	 * function allow change properties "thickness_type" value
	 * @param $p_thickness_type: string value
	 */
	public function set_thickness_type($p_thickness_type){
		$this->v_thickness_type = $p_thickness_type;
	}
	...
	public function insert(){
		$arr = array('thickness_id' => $this->v_thickness_id
					,'thickness_name' => $this->v_thickness_name
					,'thickness_size' => $this->v_thickness_size
					,'thickness_type' => $this->v_thickness_type);
		try{
	 ...
	 * @example:
	 * <code>
	 *       SELECT * FROM `tb_thickness` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_thickness($db)
	...
	public function select_one(array $arr_where = array(), array $arr_order = array()){
		...
		$v_count = 0;
		foreach($rss as $arr){
			$this->v_thickness_id = isset($arr['thickness_id'])?$arr['thickness_id']:0;
			$this->v_thickness_name = isset($arr['thickness_name'])?$arr['thickness_name']:'';
			$this->v_thickness_size = isset($arr['thickness_size'])?$arr['thickness_size']:'';
			$this->v_thickness_type = isset($arr['thickness_type'])?$arr['thickness_type']:'';
	 ...
	 * @example: 
	 * <code>
	 * SELECT `thickness_id` FROM `tb_thickness` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_thickness($db)
	 * 		 $cls->select_scalar('thickness_id',array('user_id'=>2), array('user_email'=>-1))
	 * </code>
	 * @return mixed
	 */
	 ...
	 * @example: 
	 * <code>
	 *   SELECT `thickness_id` FROM `tb_thickness` WHERE `user_id`=2 ORDER BY `thickness_id` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_thickness($db)
	 * 		 $cls->select_next('thickness_id',array('user_id'=>2), array('thickness_id'=>-1))
	 * </code>
	 * @return int
	 */
	...
	public function update(array $arr_where = array()){
		...
		if(isset($v_has_mongo_id) && $v_has_mongo_id)
			$arr = array('$set' => array('thickness_id' => $this->v_thickness_id,'thickness_name' => $this->v_thickness_name,'thickness_size' => $this->v_thickness_size,'thickness_type' => $this->v_thickness_type));

            $arr = array('$set' => array('thickness_name' => $this->v_thickness_name,'thickness_size' => $this->v_thickness_size,'thickness_type' => $this->v_thickness_type));
		try{
