...
class cls_tb_city{
	...
	private $v_city_name = '';
	private $v_city_key = '';
	private $v_city_status = 0;
	private $v_city_order = 0;
	...
	public function __construct(MongoDB $db, $p_log_dir = ""){
		...
		$this->collection = $db->selectCollection('tb_city');
		$this->collection->ensureIndex(array("city_id"=>1), array('name'=>"city_id_key", "unique"=>1, "dropDups" => 1));
	}
	...
	/**
	 * function return properties "city_id" value
	 * @return int value
	 */
	public function get_city_id(){
		return (int) $this->v_city_id;
	}

	
	/**
	 * function allow change properties "city_id" value
	 * @param $p_city_id: int value
	 */
	public function set_city_id($p_city_id){
		$this->v_city_id = (int) $p_city_id;
	}

	
	/**
	 * function return properties "city_name" value
	 * @return string value
	 */
	...
	/**
	 * function allow change properties "city_name" value
	 * @param $p_city_name: string value
	 */
	public function set_city_name($p_city_name){
		$this->v_city_name = $p_city_name;
	}

	
	/**
	 * function return properties "city_key" value
	 * @return string value
	 */
	public function get_city_key(){
		return $this->v_city_key;
	}

	
	/**
	 * function allow change properties "city_key" value
	 * @param $p_city_key: string value
	 */
	public function set_city_key($p_city_key){
		$this->v_city_key = $p_city_key;
	}

	
	/**
	 * function return properties "city_status" value
	 * @return int value
	 */
	public function get_city_status(){
		return (int) $this->v_city_status;
	}

	
	/**
	 * function allow change properties "city_status" value
	 * @param $p_city_status: int value
	 */
	public function set_city_status($p_city_status){
		$this->v_city_status = (int) $p_city_status;
	}

	
	/**
	 * function return properties "city_order" value
	 * @return int value
	 */
	public function get_city_order(){
		return (int) $this->v_city_order;
	}

	
	/**
	 * function allow change properties "city_order" value
	 * @param $p_city_order: int value
	 */
	public function set_city_order($p_city_order){
		$this->v_city_order = (int) $p_city_order;
	}
	...
	public function insert(){
		$arr = array('city_id' => $this->v_city_id
					,'city_name' => $this->v_city_name
					,'city_key' => $this->v_city_key
					,'city_status' => $this->v_city_status
					,'city_order' => $this->v_city_order
	 ...
	 * @example:
	 * <code>
	 *       SELECT * FROM `tb_city` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	...
	public function select_one(array $arr_where = array(), array $arr_order = array()){
		...
		$v_count = 0;
		foreach($rss as $arr){
			$this->v_city_id = isset($arr['city_id'])?$arr['city_id']:0;
			$this->v_city_name = isset($arr['city_name'])?$arr['city_name']:'';
			$this->v_city_key = isset($arr['city_key'])?$arr['city_key']:'';
			$this->v_city_status = isset($arr['city_status'])?$arr['city_status']:0;
			$this->v_city_order = isset($arr['city_order'])?$arr['city_order']:0;
	 ...
	 * @example: 
	 * <code>
	 *   SELECT `city_id` FROM `tb_city` WHERE `user_id`=2 ORDER BY `city_id` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_city($db)
	 * 		 $cls->select_next('city_id',array('user_id'=>2), array('city_id'=>-1))
	 * </code>
	 * @return int
	 */
	...
	public function update(array $arr_where = array()){
		...
		if(isset($v_has_mongo_id) && $v_has_mongo_id)
			$arr = array('$set' => array('city_id' => $this->v_city_id,'city_name' => $this->v_city_name,'city_key' => $this->v_city_key,'city_status' => $this->v_city_status,'city_order' => $this->v_city_order,'country_id' => $this->v_country_id));
		else
			$arr = array('$set' => array('city_name' => $this->v_city_name,'city_key' => $this->v_city_key,'city_status' => $this->v_city_status,'city_order' => $this->v_city_order,'country_id' => $this->v_country_id));
		try{
