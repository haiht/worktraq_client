<?php
class cls_tb_product_group{

	private $v_product_group_id = 0;
	private $v_company_id = 0;
	private $v_product_group_key = '';
	private $v_product_group_name = '';
	private $v_product_group_order = 0;
	private $v_product_group_parent = 0;
	...
	public function __construct(MongoDB $db, $p_log_dir = ""){
		...
		$this->collection = $db->selectCollection('tb_product_group');
		$this->collection->ensureIndex(array("company_id"=>1));
		$this->collection->ensureIndex(array("product_group_key"=>1));
		$this->collection->ensureIndex(array("product_group_parent"=>1));
		$this->collection->ensureIndex(array("product_group_id"=>1), array('name'=>"product_group_id_key", "unique"=>1, "dropDups" => 1));
	}
	...
	/**
	 * function return properties "product_group_id" value
	 * @return int value
	 */
	public function get_product_group_id(){
		return (int) $this->v_product_group_id;
	}

	
	/**
	 * function allow change properties "product_group_id" value
	 * @param $p_product_group_id: int value
	 */
	public function set_product_group_id($p_product_group_id){
		$this->v_product_group_id = (int) $p_product_group_id;
	}
	...
	/**
	 * function return properties "product_group_key" value
	 * @return string value
	 */
	public function get_product_group_key(){
		return $this->v_product_group_key;
	}

	
	/**
	 * function allow change properties "product_group_key" value
	 * @param $p_product_group_key: string value
	 */
	public function set_product_group_key($p_product_group_key){
		$this->v_product_group_key = $p_product_group_key;
	}

	
	/**
	 * function return properties "product_group_name" value
	 * @return string value
	 */
	public function get_product_group_name(){
		return $this->v_product_group_name;
	}

	
	/**
	 * function allow change properties "product_group_name" value
	 * @param $p_product_group_name: string value
	 */
	public function set_product_group_name($p_product_group_name){
		$this->v_product_group_name = $p_product_group_name;
	}

	
	/**
	 * function return properties "product_group_order" value
	 * @return int value
	 */
	public function get_product_group_order(){
		return (int) $this->v_product_group_order;
	}

	
	/**
	 * function allow change properties "product_group_order" value
	 * @param $p_product_group_order: int value
	 */
	public function set_product_group_order($p_product_group_order){
		$this->v_product_group_order = (int) $p_product_group_order;
	}

	
	/**
	 * function return properties "product_group_parent" value
	 * @return int value
	 */
	public function get_product_group_parent(){
		return (int) $this->v_product_group_parent;
	}

	
	/**
	 * function allow change properties "product_group_parent" value
	 * @param $p_product_group_parent: int value
	 */
	public function set_product_group_parent($p_product_group_parent){
		$this->v_product_group_parent = (int) $p_product_group_parent;
	}
	...
	public function insert(){
		$arr = array('product_group_id' => $this->v_product_group_id
					,'company_id' => $this->v_company_id
					,'product_group_key' => $this->v_product_group_key
					,'product_group_name' => $this->v_product_group_name
					,'product_group_order' => $this->v_product_group_order
					,'product_group_parent' => $this->v_product_group_parent);
		try{
	 ...
	 * @example:
	 * <code>
	 *       SELECT * FROM `tb_product_group` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_product_group($db)
	...
	public function select_one(array $arr_where = array(), array $arr_order = array()){
		...
		$v_count = 0;
		foreach($rss as $arr){
			$this->v_product_group_id = isset($arr['product_group_id'])?$arr['product_group_id']:0;
			$this->v_company_id = isset($arr['company_id'])?$arr['company_id']:0;
			$this->v_product_group_key = isset($arr['product_group_key'])?$arr['product_group_key']:'';
			$this->v_product_group_name = isset($arr['product_group_name'])?$arr['product_group_name']:'';
			$this->v_product_group_order = isset($arr['product_group_order'])?$arr['product_group_order']:0;
			$this->v_product_group_parent = isset($arr['product_group_parent'])?$arr['product_group_parent']:0;
	 ...
	 * @example: 
	 * <code>
	 * SELECT `product_group_id` FROM `tb_product_group` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_product_group($db)
	 * 		 $cls->select_scalar('product_group_id',array('user_id'=>2), array('user_email'=>-1))
	 * </code>
	 * @return mixed
	 */
	 ...
	 * @example: 
	 * <code>
	 *   SELECT `product_group_id` FROM `tb_product_group` WHERE `user_id`=2 ORDER BY `product_group_id` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_product_group($db)
	 * 		 $cls->select_next('product_group_id',array('user_id'=>2), array('product_group_id'=>-1))
	 * </code>
	 * @return int
	 */
	...
	public function update(array $arr_where = array()){
		...
		if(isset($v_has_mongo_id) && $v_has_mongo_id)
			$arr = array('$set' => array('product_group_id' => $this->v_product_group_id,'company_id' => $this->v_company_id,'product_group_key' => $this->v_product_group_key,'product_group_name' => $this->v_product_group_name,'product_group_order' => $this->v_product_group_order,'product_group_parent' => $this->v_product_group_parent));
		 else 
			$arr = array('$set' => array('company_id' => $this->v_company_id,'product_group_key' => $this->v_product_group_key,'product_group_name' => $this->v_product_group_name,'product_group_order' => $this->v_product_group_order,'product_group_parent' => $this->v_product_group_parent));
		try{
    ...
    public function draw_all_product_option($p_company_id,$p_parent_id, $p_value, $p_type='id',$p_level=0){

        $arr_where = array('company_id'=>(int)$p_company_id , 'product_group_parent'=>(int) $p_parent_id);

        $arr = $this->select($arr_where);
        $v_dsp_option = '';
        $v_padding = '';
        for($i=0;$i<$p_level;$i++ )
            $v_padding .="----";
        ...
        foreach($arr as $a){
            $v_product_group_id = isset($a['product_group_id']) ? $a['product_group_id'] : 0;
            $v_product_group_key = isset($a['product_group_key']) ? $a['product_group_key'] : '';
            $v_product_group_name = isset($a['product_group_name']) ? $a['product_group_name'] : '';

            if($p_type=='id'){
               if($v_product_group_id==$p_value)
                   $v_dsp_option .= '<option value="'.$v_product_group_id.'" selected="selected">'.$v_padding. $v_product_group_name.'</option>';
               else
                   $v_dsp_option .= '<option value="'.$v_product_group_id.'" >'.$v_padding.$v_product_group_name.'</option>';
            }
            else
            {
                if($v_product_group_key==$p_value)
                    $v_dsp_option .= '<option value="'.$v_product_group_id.'" selected="selected">'.$v_padding.$v_product_group_name.'</option>';
                else
                    $v_dsp_option .= '<option value="'.$v_product_group_id.'" >'.$v_padding.$v_product_group_name.'</option>';
            }
            $v_dsp_option .= $this->draw_all_product_option($p_company_id ,$v_product_group_id,$p_value, $p_type,++$p_level);
        }
        return $v_dsp_option;
