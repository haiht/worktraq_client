<?php
class cls_tb_image_area{

	private $v_location_area_id = 0;
	private $v_location_area_name = '';
	private $v_status = 0;
	private $v_location_area_order = 0;
	private $v_location_id = 0;
	private $v_company_id = 0;
	private $v_user_name = '';
	private $v_date_created = '';
	...
	public function __construct(MongoDB $db, $p_log_dir = ""){
		...
		$this->collection = $db->selectCollection('tb_image_area');
		$this->collection->ensureIndex(array("location_area_id"=>1), array('name'=>"location_area_id_key", "unique"=>1, "dropDups" => 1));
	}
	...
	/**
	 * function return properties "location_area_id" value
	 * @return int value
	 */
	public function get_location_area_id(){
		return (int) $this->v_location_area_id;
	}

	
	/**
	 * function allow change properties "location_area_id" value
	 * @param $p_location_area_id: int value
	 */
	public function set_location_area_id($p_location_area_id){
		$this->v_location_area_id = (int) $p_location_area_id;
	}

	
	/**
	 * function return properties "location_area_name" value
	 * @return string value
	 */
	public function get_location_area_name(){
		return $this->v_location_area_name;
	}

	
	/**
	 * function allow change properties "location_area_name" value
	 * @param $p_location_area_name: string value
	 */
	public function set_location_area_name($p_location_area_name){
		$this->v_location_area_name = $p_location_area_name;
	}
	...
	/**
	 * function return properties "location_area_order" value
	 * @return int value
	 */
	public function get_location_area_order(){
		return (int) $this->v_location_area_order;
	}

	
	/**
	 * function allow change properties "location_area_order" value
	 * @param $p_location_area_order: int value
	 */
	public function set_location_area_order($p_location_area_order){
		$this->v_location_area_order = (int) $p_location_area_order;
	}
	...
	public function get_date_created(){
		return $this->v_date_created;
	}

	
	/**
	 * function allow change properties "date_created" value
	 * @param $p_date_created: string value
	 */
	...
	public function insert(){
		$arr = array('location_area_id' => $this->v_location_area_id
					,'location_area_name' => $this->v_location_area_name
					,'status' => $this->v_status
					,'location_area_order' => $this->v_location_area_order
	 ...
	 * @example:
	 * <code>
	 *       SELECT * FROM `tb_image_area` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_image_area($db)
	...
	public function select_one(array $arr_where = array(), array $arr_order = array()){
		...
		$v_count = 0;
		foreach($rss as $arr){
			$this->v_location_area_id = isset($arr['location_area_id'])?$arr['location_area_id']:0;
			$this->v_location_area_name = isset($arr['location_area_name'])?$arr['location_area_name']:'';
			$this->v_status = isset($arr['status'])?$arr['status']:0;
			$this->v_location_area_order = isset($arr['location_area_order'])?$arr['location_area_order']:0;
			...
			$this->v_date_created = isset($arr['date_created'])?$arr['date_created']:'';
	 ...
	 * @example: 
	 * <code>
	 * SELECT `location_area_id` FROM `tb_image_area` WHERE `user_id`=2 ORDER BY `user_email` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_image_area($db)
	 * 		 $cls->select_scalar('location_area_id',array('user_id'=>2), array('user_email'=>-1))
	 * </code>
	 * @return mixed
	 */
	 ...
	 * @example: 
	 * <code>
	 *   SELECT `location_area_id` FROM `tb_image_area` WHERE `user_id`=2 ORDER BY `location_area_id` DESC LIMIT 0,1
	 * 		 $cls = new cls_tb_image_area($db)
	 * 		 $cls->select_next('location_area_id',array('user_id'=>2), array('location_area_id'=>-1))
	 * </code>
	 * @return int
	 */
	...
	public function select_distinct($p_field_name){
		return $this->collection->command(array("distinct"=>"tb_image_area", "key"=>$p_field_name));
	}
	...
	public function update(array $arr_where = array()){
		...
		if(isset($v_has_mongo_id) && $v_has_mongo_id)
			$arr = array('$set' => array('location_area_id' => $this->v_location_area_id,'location_area_name' => $this->v_location_area_name,'status' => $this->v_status,'location_area_order' => $this->v_location_area_order,'location_id' => $this->v_location_id,'company_id' => $this->v_company_id,'user_name' => $this->v_user_name,'date_created' => $this->v_date_created));
		 else 
			$arr = array('$set' => array('location_area_name' => $this->v_location_area_name,'status' => $this->v_status,'location_area_order' => $this->v_location_area_order,'location_id' => $this->v_location_id,'company_id' => $this->v_company_id,'user_name' => $this->v_user_name,'date_created' => $this->v_date_created));
		try{
