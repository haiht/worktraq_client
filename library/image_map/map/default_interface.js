...
function gui_addArea(id) {
	...
	temp+= '</select> &nbsp';
	temp+= 'Coords: <input type="text" name="img_coords" class="img_coords" value=""> &nbsp';
	temp+= 'Href: <input type="text" name="img_href" class="img_href" value=""> &nbsp';
	temp+= 'Alt: <input type="text" name="img_alt" class="img_alt" value=""> &nbsp';
...
function gui_outputChanged() {
	...
	if (output == 'css') {
		...
		temp+= '(<a href="http://www.htmlhelp.com/reference/html40/special/maps.html">read more</a>). ';
	}
