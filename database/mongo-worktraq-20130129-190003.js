...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-29T11:29:30.0Z"),
  "user_name": "admin",
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-29T11:32:26.0Z"),
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-29T11:00:52.0Z"),
  "user_name": "demo_fgl",
  "user_password": "48861e56b31b907686c75debf2167db4",
  "user_rule": {
    "customer_order": {
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-29T11:30:52.0Z"),
  "user_location_approve": "",
  "user_name": "demo_vht1",
  "user_password": "48861e56b31b907686c75debf2167db4",
  "user_rule": {
