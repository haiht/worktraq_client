...
db.getCollection("tb_contact").insert({
  ...
  "contact_type": "1",
  "direct_phone": "403.255.2740",
  "email": "test_manager_vht@localhost.com",
  "fax_number": "",
  "first_name": "Test",
  "home_phone": "",
  "last_name": "Manager",
...
db.getCollection("tb_module").insert({
  ...
  "module_root": "admin",
  "module_text": "Roles",
  "module_time": ISODate("2013-01-17T04:07:55.0Z"),
  "module_type": NumberInt(0)
});
db.getCollection("tb_module").insert({
...
db.getCollection("tb_rule").insert({
  ...
  "rule_menu": "",
  "rule_title": "Insert, Edit, Order",
  "rule_type": NumberInt(4)
});
db.getCollection("tb_rule").insert({
  "_id": ObjectId("50f77b4f9c76844a07000015"),
  "rule_id": NumberInt(13),
  "rule_title": "Insert, Edit, Products",
  "rule_type": NumberInt(3),
  "rule_key": "insert_edit_products",
  "rule_admin": NumberInt(0),
  "rule_menu": ""
});
db.getCollection("tb_rule").insert({
  "_id": ObjectId("50f77b719c76844d07000007"),
  "rule_id": NumberInt(14),
  "rule_title": "Manage Singage Layout",
  "rule_type": NumberInt(3),
  "rule_key": "manage_signage_layout",
  "rule_admin": NumberInt(0),
  "rule_menu": ""
});
db.getCollection("tb_rule").insert({
  ...
  "rule_admin": NumberInt(0),
  "rule_comp": NumberInt(0),
  "rule_description": "Include insert, update, delete companies                ",
  "rule_id": NumberInt(1),
  "rule_key": "manage_company",
  "rule_menu": "",
  "rule_title": "Manage Companies",
  "rule_type": NumberInt(0)
});
db.getCollection("tb_rule").insert({
...
db.getCollection("tb_rule").insert({
  "_id": ObjectId("50f8cfc19c7684bd0600001a"),
  "rule_id": NumberInt(16),
  "rule_title": "Manage Package",
  "rule_type": NumberInt(3),
  "rule_key": "manage_package",
  "rule_admin": NumberInt(0),
  "rule_menu": "",
  "rule_comp": NumberInt(0),
  "rule_description": "Manage about add product to Package, Kit,          "
});
db.getCollection("tb_rule").insert({
...
db.getCollection("tb_user").insert({
  ...
  "company_id": NumberInt(10006),
  "location_id": NumberInt(10000),
  "user_lastlog": ISODate("2013-01-22T01:50:26.0Z"),
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-23T09:59:42.0Z"),
  "user_name": "admin",
  "user_password": "e10adc3949ba59abbe56e057f20f883e",
  "user_status": NumberInt(0),
  "user_type": NumberInt(0),
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-23T09:36:21.0Z"),
  "user_name": "demo_vht",
  "user_password": "e10adc3949ba59abbe56e057f20f883e",
  "user_rule": "insert_edit_delete_order,allocate_to_different_locations,edit_submitted_order,cancel_order,approve_order,",
  "user_status": NumberInt(0),
  "user_type": NumberInt(5)
});
db.getCollection("tb_user").insert({
  ...
  "company_id": NumberInt(10004),
  "location_id": NumberInt(10004),
  "user_lastlog": ISODate("2013-01-23T08:32:16.0Z"),
  "user_rule": ""
});
