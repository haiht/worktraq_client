...
db.getCollection("tb_module").insert({
  ...
  "module_text": "Order",
  "module_time": ISODate("2013-01-29T07:56:53.0Z"),
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-29T07:48:08.0Z"),
  "user_name": "admin",
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-28T08:18:48.0Z"),
  "user_location_approve": "10015",
  "user_name": "demo_vht",
  "user_password": "48861e56b31b907686c75debf2167db4",
  "user_rule": {
    "customer_order": {
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-28T07:34:48.0Z"),
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-28T08:47:00.0Z"),
  "user_name": "demo_fgl",
  "user_password": "48861e56b31b907686c75debf2167db4",
  "user_rule": {
    "customer_order": {
...
db.getCollection("tb_user").insert({
  ...
  "user_lastlog": ISODate("2013-01-28T07:58:50.0Z"),
  "user_location_approve": "",
  "user_name": "demo_vht1",
  "user_password": "48861e56b31b907686c75debf2167db4",
  "user_rule": {
